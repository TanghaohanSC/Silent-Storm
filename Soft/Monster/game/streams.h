...
public:
	...
	bool IsOk() { return ( nFlags & F_Failed ) == 0; }
	...
	void CopyFrom( CDataStream &src ) { ASSERT(0); } // CRAP
...
public:
	...
	void CloseFile();
	bool OpenRead( const char *pszFName ) { Open( pszFName, "rb", F_CanRead ); return IsOk(); }
	bool OpenWrite( const char *pszFName ) { Open( pszFName, "wb", F_CanWrite ); return IsOk(); }
	bool Open( const char *pszFName ) { Open( pszFName, "r+b" ); return IsOk(); }
};
/////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////
