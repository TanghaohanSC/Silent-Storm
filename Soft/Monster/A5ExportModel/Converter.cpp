...
template<class TData>
	static bool CheckCache( CSharedDesc<TData> &res, void *_pManager ) { return res.pManager == _pManager && res.pData->IsValid(); }
template<class TData>
...
void AddFace( int *pIndices )
{
	...
	faces.push_back( SFace( pV1->nNumber, pV2->nNumber, pV3->nNumber ) );
}
