...
{
	return float( pSlider->GetValue() ) / pSlider->GetMaxValue();
}
////////////////////////////////////////////////////////////////////////////////////////////////////
void CComplexSlider::SetValue( float fVal )
{
	pSlider->SetValue( pSlider->GetMaxValue() * fVal );
	UpdateControls();
}
////////////////////////////////////////////////////////////////////////////////////////////////////
...
{
	pSlider->UpdateText();
	pProgress->SetValue( ( float( pSlider->GetValue() ) / pSlider->GetMaxValue() ) * 0.9f + 0.1f );
}
////////////////////////////////////////////////////////////////////////////////////////////////////
...
COptionsInterface::COptionsInterface():
	bindClose( "cancel" ), bindVideoOptions( "video" ), bindAudioOptions( "audio" ), bindGamePlayOptions( "gameplay" ), bindControlsOptions( "controls" )
{
}
////////////////////////////////////////////////////////////////////////////////////////////////////
