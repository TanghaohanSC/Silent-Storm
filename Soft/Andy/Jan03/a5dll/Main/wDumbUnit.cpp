...
void CDumbUnitServer::CreateFlash()
{
	...
	else if ( NRPG::IWeaponItem* pW = (NRPG::IWeaponItem*)(CDynamicCast<NRPG::IWeaponItem>( pRPG->GetInventory()->GetActive() )) )
		pRPGWeapon = pW;
	else
		return;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
class CShowBloodUpdated { public: int dummy; };  // silent-storm-port: needs complete for ThrowEvent typeid
