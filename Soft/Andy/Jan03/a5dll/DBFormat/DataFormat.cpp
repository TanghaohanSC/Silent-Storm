...
////////////////////////////////////////////////////////////////////////////////////////////////////
// Подходящий вариант если у него совсем нет атрибутов или присутствуют
// все атрибуты из vInputParams и других флагов нет
// !!! attrs и vInputParams должены быть отсортированными массивами
////////////////////////////////////////////////////////////////////////////////////////////////////
...
void CAnimation::Import()
{
	...
	{
		// чтобы не нарушать порядок импорта полей (из-за оптимизации в BasicDB.h)
		int n;
	...
	const char *pszParams, int nClassSexFlags, CSide *pSide, bool bMostPossible ) const
{
	...
	{
		// возвращаем наиболее вероятную анимацию
		CAnimation *pRes = 0;
