...
////////////////////////////////////////////////////////////////////////////////////////////////////
// SKILLS Основные наборы RPG характеристик 
////////////////////////////////////////////////////////////////////////////////////////////////////
enum ESkillType
{
	// оружейные скилы
...
////////////////////////////////////////////////////////////////////////////////////////////////////
// у монстров не модифицируются статами
struct SRPGSkills
{
...
public:
	...
	enum
	{
		HUMAN_BODY = 1,	// Человек
		GROUND,			// Грунт
		STONE,			// Камень
		WOOD,			// Дерево
		BRICK,			// Кирпич
		CLOTH = 20,		// Ткань
		STEEL,			// Сталь (корпус автомашины)
		ARMOR_STEEL1,	// Бронестваль гомогенная
		ARMOR_STEEL2,	// Бронесталь цементированная
	};
	ZDATA_(CDBRecord)
...
public:
	...
	bool bScope; // снайперский прицел
	string szAnimName;
	int nQuality;
	CPtr<CTEffect> pShotEffect;
...
public:
	...
	int nDuration;
	float fPower;
	int nTotalHealVP; // количество хитов, которое можно отлечить этой аптечкой
	int nAPToUse;
