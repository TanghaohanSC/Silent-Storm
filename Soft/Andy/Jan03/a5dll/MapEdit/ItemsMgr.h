...
private:
  ...
  std::hash_map<int, int>  foldID2Index;    // отображение ID папки в индекс в векторе folderList
  std::hash_map<int, int>  itemID2Index;    // отображение ID итема в индекс в векторе itemList
