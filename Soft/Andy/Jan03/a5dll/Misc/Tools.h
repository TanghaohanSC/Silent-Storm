...
////////////////////////////////////////////////////////////////////////////////////////////////////
// silent-storm-port: was `return find(c.begin(),c.end(),e)!=c.end();` — std::find
// triggers ambiguous `==` under modern MSVC for CPtr<T> vs T*. Manual loop +
// global non-template operator== (in Basic2.h) disambiguates.
...
// silent-storm-port 2026-05-11: removed `inline float fabs(float)` —
// modern std <cmath> provides float overloads natively; Nival's inline
// duplicate triggered C2084 (function already has a body).
...
////////////////////////////////////////////////////////////////////////////////////////////////////
// silent-storm-port 2026-05-11: removed `inline float cos/sin/acos/asin(float)` —
// modern std <cmath> provides these float overloads natively.
//inline float cos( float fVal ) noexcept { return static_cast<float>( cos( double(fVal) ) ); }
//inline float sin( float fVal ) noexcept { return static_cast<float>( sin( double(fVal) ) ); }
//inline float acos( float fVal ) noexcept { return static_cast<float>( acos( double(fVal) ) ); }
//inline float asin( float fVal ) noexcept { return static_cast<float>( asin( double(fVal) ) ); }
////////////////////////////////////////////////////////////////////////////////////////////////////
