...
public :
	// silent-storm-port 2026-05-11: explicit default ctor — anonymous union
	// of non-trivial types (CVec3/CVec4) implicitly deletes the default ctor
	// under modern C++. Empty body matches pre-C++11 implicit behavior.
	SHMatrix() {}
