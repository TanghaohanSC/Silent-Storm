...
namespace NGfx
{
	...
	extern bool bHardwareVP, bHardwarePixelShaders, bHardwarePixelShaders14;
	extern bool bTnLDevice;
	extern bool bDoValidateDevice;
	extern bool bNVHackNP2, bUseAnisotropy, bBanNP2, bBan32BitIndices, bStaticNooverwrite;
	extern bool bNoCubeMapMipLevels;
	extern int nDepthTexResolution;
	extern D3DCAPS8 devCaps;
////////////////////////////////////////////////////////////////////////////////////////////////////
// Vertex info
////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
	...
	void Create( const DWORD *pShader, const DWORD *pdwDataLayout )
	{
		HRESULT hr;
		//
		hr = pDevice->CreateVertexShader( 
			...
			pShader,
			&dwVS, 
			bHardwareVP ? 0: D3DUSAGE_SOFTWAREPROCESSING );
		ASSERT( D3D_OK == hr );
	}
};
////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
	...
	virtual void DrawPrimitive( int nVBStart, int nVBSize ) = 0;
