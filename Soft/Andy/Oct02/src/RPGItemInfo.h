...
public:
	virtual int GetWeight() const = 0;
	virtual int GetEmptySpace() const = 0;
	...
	virtual bool CanWear( const IInventoryItem *pWhat ) const = 0;
	virtual IInventoryItem *Get( NDb::ESlot where ) const = 0;
	virtual IInventoryItem *GetUniform() const = 0;
...
struct SWeaponInfo
{
	...
	int nRecoil;
	float fMinToHitCoeff, fMaxToHitCoeff;
	int nDmgMin, nDmgMax;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
class IGrenadeItem: virtual public IInventoryItem
{
public:
	virtual NDb::CRPGGrenade *GetDBGrenade() const = 0;
};
////////////////////////////////////////////////////////////////////////////////////////////////////
class IUniformItem: virtual public IInventoryItem
{
public:
	virtual NDb::CRPGUniform *GetDBUniform() const = 0;
};
////////////////////////////////////////////////////////////////////////////////////////////////////
...
{
public:
	virtual NDb::CRPGMineDetector* GetDBMineDetector() const = 0;
};
////////////////////////////////////////////////////////////////////////////////////////////////////
} // namespace
////////////////////////////////////////////////////////////////////////////////////////////////////
