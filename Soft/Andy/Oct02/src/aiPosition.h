...
//	void GetHInfo( SHeightCalcInfo *pRes ) const;
	bool IsLocked() const;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
enum EPose	// НЕ МЕНЯТЬ МЕСТАМИ! Это завязанно на вычесление AP!
{
	CRAWL = 0,	// ползком
	CROUCH,		// присев
	WALK,		// стоя
...
public:
	...
	virtual bool IsLocked( const SPathPlace &p ) const = 0;
	...
	virtual void UpdateColouring( const vector<SPathPlace> &newLockers ) = 0;
	...
	virtual SPathPlace GetDeployPlace( const SPathPlace &cur, bool bFirst ) = 0;
};
////////////////////////////////////////////////////////////////////////////////////////////////////
