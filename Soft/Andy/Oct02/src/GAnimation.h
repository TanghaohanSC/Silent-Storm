...
struct SSkeletonState
{
	...
	ZEND int operator&( CStructureSaver &f ) { f.Add(2,&cIdleBannedFlags); f.Add(3,&nAnimFlags); f.Add(4,&szParams); f.Add(5,&pos); f.Add(6,&fAngle); f.Add(7,&bCrawl); f.Add(8,&pTerrain); return 0; }
...
public:
	...
	ZEND int operator&( CStructureSaver &f ) { f.Add(1,(CAnimator*)this); f.Add(2,&current); f.Add(3,&tCurrent); f.Add(4,&pIdleAnim); f.Add(5,&tIdleEnd); f.Add(6,&pAnimator); f.Add(7,&pSkeleton); f.Add(8,&pNextPose); f.Add(9,&pState); f.Add(10,&pNextPoseTime); return 0; }
...
public:
	...
	CSkeletonAnimator( NDb::CSkeleton *_pSkeleton = 0 );
	...
	void AddDynamics( STime tFrom, const CVec3 &impact, NAI::IAIMap *pMap, CAnimator *pEffector = 0 );
	// later
...
public:
	...
	CAddBoneFilter( int _nAddBone = 0 ) : nAddBone(_nAddBone) {}
...
public:
	...
	CAddBoneLocators( int _nAddBone = 0, NDb::CGeometry *pGeometry = 0 );
