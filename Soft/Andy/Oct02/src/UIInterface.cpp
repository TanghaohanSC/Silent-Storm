...
void CLoader::Load( CWindow* _pParent, NDb::CUIContainer *pTemplate )
{
	...
	for ( int nTemp = 0; nTemp < windowsSet.size(); nTemp++ )
	{
		...
		if ( IsValid( pControl ) )
		{
			if ( pControl->bDefault )
				pParent->SendMessage( pParent, SEvent( EVENT_ACTIVATEREQ, pWindow ) );
		}
	}
...
const SWindowInfo& CLoader::GetControl( const string &szID )
{
	...
	sWindow.second.sInfo = SWindowInfo( pParent, SPoint( 0, 0 ) , SPoint( 0, 0 ), "", 0 );
...
CInterface::CInterface(): 
	...
	cmdConsole( "console" ), cmdFPSShow( "showfps" )
{
}
////////////////////////////////////////////////////////////////////////////////////////////////////
CInterface::CInterface( ICursor* _pCursor ): 
...
{
	if ( sInfo.pTexture )
		pCursor->SetCursor( sInfo );
	else
		pCursor->SetCursor( sDefaultCursor );
}
////////////////////////////////////////////////////////////////////////////////////////////////////
