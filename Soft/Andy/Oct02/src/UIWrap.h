...
protected:
	...
	ZEND int operator&( CStructureSaver &f ) { f.Add(2,&sWindow); f.Add(3,&sColor); f.Add(4,&pModel); f.Add(5,&pBaseTransform); f.Add(6,&p3DView); f.Add(7,&pRender); f.Add(8,&pTransform); f.Add(9,&pAmbientDirectional); return 0; }
