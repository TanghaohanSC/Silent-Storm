...
////////////////////////////////////////////////////////////////////////////////////////////////////
static void GetTransparentTexturePlace( STransparentTexturePlace *pRes, NGfx::CTexture *pTex )
{
	...
	NGfx::CalcTexCoords( &pRes->vUVs[0], fUStart, fVFinish );
	NGfx::CalcTexCoords( &pRes->vUVs[1], fUFinish, fVFinish );
	NGfx::CalcTexCoords( &pRes->vUVs[2], fUFinish, fVStart );
	NGfx::CalcTexCoords( &pRes->vUVs[3], fUStart, fVStart );
}
////////////////////////////////////////////////////////////////////////////////////////////////////
static void GetGrassTexturePlace( vector<STransparentTexturePlace> *pRes, int nGrass, NGfx::CTexture *pTex )
{
	...
	int nVStart = toSplit.vUVs[2].nV;
	int nVSize = toSplit.vUVs[0].nV - nVStart;
