...
bool CheckObjectStability( IAIMap *pMap, NDb::CModel *pModel, const SHMatrix &_pos, NWorld::IVisObj *pIgnore )
{
	if ( !pModel )
		return true;
	...
	{
		if ( pMap->CalcIntersection( spheres[i].ptCenter, spheres[i].fRadius, NWorld::TS_TERRAINS | NWorld::TS_OBJECTS, pIgnore ) )
