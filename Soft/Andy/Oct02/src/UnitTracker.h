...
private:
	...
	vector< CObj<NGScene::CRenderNode> > digidNodesSet;
	vector< CObj<NGScene::CLightGroup> > digidGroupsSet;

	CPtr<NWorld::CUnit> pLastEnemyUnit;
	vector<CPtr<NWorld::CUnit> > enemySet;
	ZEND int operator&( CStructureSaver &f ) { f.Add(2,&pMission); f.Add(3,&pUnit); f.Add(4,&bActive); f.Add(5,&nFloor); f.Add(6,&bSelected); f.Add(7,&bHilighted); f.Add(8,&pSelection); f.Add(9,&bPathVisible); f.Add(10,&bStrafeMove); f.Add(11,&bHilightTarget); f.Add(12,&nTargetAP); f.Add(13,&vTargetPos); f.Add(14,&sTarget); f.Add(15,&pPath); f.Add(16,&pPathAPText); f.Add(17,&nodesSet); f.Add(18,&groupsSet); f.Add(19,&digidNodesSet); f.Add(20,&digidGroupsSet); f.Add(21,&pLastEnemyUnit); f.Add(22,&enemySet); return 0; }
...
public:
	...
	bool IsStrafeMove() const;
	void SetStrafeMove( bool bState );
