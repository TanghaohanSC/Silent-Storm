...
// IML
////////////////////////////////////////////////////////////////////////////////////////////////////
typedef void (*TAGHandler)( IMLLayout *pLayout, const vector<wstring> &paramsSet, void *pContext );
////////////////////////////////////////////////////////////////////////////////////////////////////
class IML: public CObjectBase
{
public:
	virtual void SetText( const wstring &wsText, int nFlags ) = 0;
	virtual void SetHandler( const wstring &wsTAG, TAGHandler pHandler, void *pContext ) = 0;
