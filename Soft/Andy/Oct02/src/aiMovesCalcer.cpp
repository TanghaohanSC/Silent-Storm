...
CMovesCalcer::STile &CMovesCalcer::GetFlipperTile(
	int x, int y, const SDoorColliderAnalyzer &analyzer, const STile &t, char *pNFlipper )
{
...
// CLadderCalcer
////////////////////////////////////////////////////////////////////////////////////////////////////
CLadderCalcer::CLadderCalcer( CNodesLayer *_pLayer, IAIMap *_pMap, CNodesLayer::SLadder *_pLadder, vector<bool> *_pRes )
