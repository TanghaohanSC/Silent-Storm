...
namespace NBuilding
{
const float PLANE_DIST = WALL_HEIGHT / 4; // расстояние между плоскостями
const float MIN_NODE_DIST = FP_GRID_STEP; // мин. расстояние между узлами
const float MIN_ADDITIVE_DMG = 50;
const int N_MAX_HP = 254;
...
bool CBuildingGrid::DamageSpot( const SPoint3 &pt, int nDmg )
{
	if ( !IsValidCoord( pt ) )
		return false;
	BYTE &node = At( pt );
	if ( 0 == node || N_INDESTRUCTIBLE == node )
		return false;
...
void CBuildingGrid::Reset()
{
	if ( NeedComputeStability() )
		...
		net.FillEvery( N_INDESTRUCTIBLE - 1 );
	Updated();
}
////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool CBuildingGrid::IsIndestructible( const SPoint3 &pt )
{
	return N_INDESTRUCTIBLE == At( pt );
}
////////////////////////////////////////////////////////////////////////////////////////////////////
