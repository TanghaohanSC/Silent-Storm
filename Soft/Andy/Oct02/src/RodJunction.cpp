...
void CJunction::Init()
{
	const int CONSTANT_FLAGS = FLAG_GROUND | FLAG_CELLARWALL | FLAG_FILLED;
...
void CJunction::SetDestroyLimits( NDb::CRPGArmor *pArmor )
{
	...
	fUltimatePressure = Max( fUltimatePressure, pArmor->fUltimatePresure );
	fUltimateMoment = Max( fUltimateMoment, pArmor->fUltimateMoment );
}
////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool CJunction::IsLinkBroken( EDirection dir, int nJuncHP ) const 
{
	const float f = (1.0f / 3.0f) * fUltimateMoment;
	//return fabs( GetMoment(dir) ) > 2 * f + f * nJuncHP * NHPSCALE;
