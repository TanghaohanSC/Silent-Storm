...
////////////////////////////////////////////////////////////////////////////////////////////////////
void MakeMatrix( SFBTransform *pRes, float fpTangazh, float fpRiskanie, const CVec3 &pos )
{
	MakeMatrix( &pRes->forward, fpTangazh, fpRiskanie, pos );
...
void MakeMatrix( SHMatrix *pRes, const CVec3 &ptPos, const CVec3 &ptDir )
{
	...
	MakeMatrix( pRes, fpTang, fpRisk, ptPos );
}
////////////////////////////////////////////////////////////////////////////////////////////////////
