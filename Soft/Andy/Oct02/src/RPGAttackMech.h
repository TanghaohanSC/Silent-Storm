...
public:
	...
	ZEND int operator&( CStructureSaver &f ) { f.Add(2,&nK); f.Add(3,&nDmgType); f.Add(4,&nDmgMin); f.Add(5,&nDmgMax); f.Add(6,&nCrtical); f.Add(7,&nCrticalDifficulty); f.Add(8,&rTtrajectory); f.Add(9,&pAttacker); f.Add(10,&pTarget); f.Add(11,&fDamageCoeff); f.Add(12,&atkType); f.Add(13,&nUnconsciousProbability); return 0; }
	CAttackPortion() {}
	CAttackPortion( int _nK, int _nDmgType, int _nDmgMin, int _nDmgMax, 
		...
		IUnitMissionInfo *_pTarget = 0, float _fDamageCoeff = 1, int _nUnconsciousProbability = 0 ):
			...
			fDamageCoeff( _fDamageCoeff ), atkType( AT_NORMAL ), nUnconsciousProbability( _nUnconsciousProbability ) {}
