...
public:
	CAILogPosition() {}
	CAILogPosition(	IAIUnit *_pAIUnit, SPosition _pSourcePosition, SPosition _pTargetPosition );
	// IAILogRecord
	virtual void RollBack();
	virtual void Commit();
	virtual void GetCommands( list< CPtr<NWorld::CCommand> > *Commands );
...
class CAILogChangeWeapon: public CAILogRecord
{
	...
	ZDATA
	ZPARENT(CAILogRecord)
	CPtr<IAIWeapon> pOldWeapon;
	CPtr<IAIWeapon> pNewWeapon;
...
public:
	//
	CAILogChangeWeapon() {}
	CAILogChangeWeapon(	IAIUnit *_pAIUnit, IAIWeapon *pWeapon );
	// IAILogRecord
	virtual void RollBack();
	virtual void Commit();
	virtual void GetCommands( list< CPtr<NWorld::CCommand> > *Commands );
...
public:
	//
	CAILogAddWeapon() {}
	CAILogAddWeapon(	IAIUnit *_pAIUnit, IAIWeapon *_pWeapon );
	// IAILogRecord
	virtual void RollBack();
	virtual void Commit();
	virtual void GetCommands( list< CPtr<NWorld::CCommand> > *Commands );
...
public:
	//
	CAILogAddWeaponClip() {}
	CAILogAddWeaponClip(	IAIUnit *_pAIUnit, IAIWeapon *_pWeapon, IAIWeaponClip *_pClip );
	// IAILogRecord
	virtual void RollBack();
	virtual void Commit();
	virtual void GetCommands( list< CPtr<NWorld::CCommand> > *Commands );
...
class CAILogThrowGrenade: public CAILogRecord
{
	...
	ZPARENT(CAILogRecord)
	CPtr<IAIUnit> pTarget;
	ZEND int operator&( CStructureSaver &f ) { f.Add(2,(CAILogRecord*)this); f.Add(3,&pTarget); return 0; }
public:
	CAILogThrowGrenade() {}
	CAILogThrowGrenade(	IAIUnit *_pAIUnit, IAIUnit *_pTarget );
	// IAILogRecord
	virtual void RollBack();
	virtual void Commit();
	virtual void GetCommands( list< CPtr<NWorld::CCommand> > *Commands );
...
public:
	...
	CAILogChangeShootMode( IAIUnit *_pAIUnit, NDb::EShootMode _eShootMode );
	// IAILogRecord
	virtual void RollBack();
	virtual void Commit();
	virtual void GetCommands( list< CPtr<NWorld::CCommand> > *Commands );
