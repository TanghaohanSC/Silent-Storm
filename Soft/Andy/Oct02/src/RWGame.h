...
{
public:
	virtual CObjectBase* Select( NWorld::IVisObj *pSelect, const CVec4 &vColor = CVec4( 0, 1, 1, 1 ) ) = 0;

	virtual CCTime* GetTime() = 0;
	virtual NLSHead::CHeadsController* GetHeadController() const = 0;

	virtual void UpdateViewWorld( bool bAdvanceTime, STime currentTime, NWorld::IPlayer *pViewFrom, bool bShowUnits = true ) = 0;
