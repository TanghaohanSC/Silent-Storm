...
// CGrassTracker
////////////////////////////////////////////////////////////////////////////////////////////////////
CGrassTracker::CGrassTracker( CFuncBase<STerrainInfo> *_pInfo, NAI::IAIMap *_pAIMap )
: pInfo(_pInfo)
{
		...
		for ( int y = 0; y < nYSize; ++y )
		{
			for ( int x = 0; x < nXSize; ++x )
			{
				if ( IsSectorFilled( nRes - 1, x, y ) )
					res.grass[y][x] = new CGrassPosCalcer( i, x, y, _pAIMap, pInfo );
			}
		}
	}
	layers.resize( nRes );
...
// CGrass
////////////////////////////////////////////////////////////////////////////////////////////////////
CGrassTracker* CGrass::CreateTracker( CFuncBase<STerrainInfo> *pInfo )
{
