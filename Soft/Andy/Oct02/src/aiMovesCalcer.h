...
class CMovesCalcer
{
	...
	//void TestLadders( NAI::CCollider *pCollider, vector<bool> *pRes );
	//void TestWLadders( NAI::CCollider *pCollider, vector<bool> *pRes );
	...
	STile &GetFlipperTile( int x, int y, const SDoorColliderAnalyzer &analyzer, const STile &t, char *pNFlipper );
public:
...
class CLadderCalcer
{
	...
	vector<bool> *pRes;
public:
	CLadderCalcer( CNodesLayer *_pLayer, IAIMap *_pMap, CNodesLayer::SLadder *_pLadder, vector<bool> *_pRes );
	void Calc();
};	
}
#endif
