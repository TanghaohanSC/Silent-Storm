...
public:
	...
	CToHitCalcer( IUnitMission *_pUnitMission, NAI::EPose _eCurPose, 
		...
		int _nHitCover, bool _bFirstRound,	CVec3 _ptIllumination, int _nBullet	);
...
public:
	...
	CAIUnitToHitCalcer() {}
	CAIUnitToHitCalcer(	NAI::IAIUnit *pShooter, NAI::IAIUnit *pTarget, int nHitCover,
