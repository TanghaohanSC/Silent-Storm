...
{
	if ( !pAIUnit->IsUnderAIControl() || 
		pAIUnit->GetUnitServer()->IsDead() || pAIUnit->GetUnitServer()->IsUnconscious() )
		return 0;
...
{
	// 50% םא 15ל ט 100% םא 0ל, םמ םו במכüרו 2-ץ unit-מג
	++nCount;
...
{ 
	...
	pTask->AddLookAround();
	pAIUnit->AssignControl( CreateAITaskControl( GetAICommander( pAIUnit ), pTask, AI_CONTROL_ERASABLE ) );
}
////////////////////////////////////////////////////////////////////////////////////////////////////
...
void CAIRevealEnemySignal::Process( IAIUnit *pAIUnit )
{
	...
	ASSERT( IsValid( pAIUnit->GetUnitServer() ) );
	//
	pAIUnit->AssignControl( CreateAITacticalControl( GetAICommander( pAIUnit ), pAIUnit ) );
}
////////////////////////////////////////////////////////////////////////////////////////////////////
...
bool CAISoundSignal::CanDetect( IAIUnit *pAIUnit )
{
	ASSERT( IsValid( pAIUnit ) );
	//
	return fabs( pAIUnit->GetUnitServer()->GetPosition().GetCP() - ptPos ) <= fRadius;
}
////////////////////////////////////////////////////////////////////////////////////////////////////
// CAICorpseSignal
////////////////////////////////////////////////////////////////////////////////////////////////////
...
{
	CVec3 ptCorpse;
	pCorpse->GetWorld()->GetAIMap()->GetUnitHLPos( &ptCorpse, pCorpse, -1 );
	return ptCorpse;
}
////////////////////////////////////////////////////////////////////////////////////////////////////
