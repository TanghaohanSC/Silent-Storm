...
class CAICommander: public NWorld::CCommander
{
	...
	bool bAITurn;
	ZEND int operator&( CStructureSaver &f ) { f.Add(2,(NWorld::CCommander *)this); f.Add(3,&pPlayer); f.Add(4,&pTaskCommander); f.Add(5,&pTacticalCommander); f.Add(6,&LockedObjects); f.Add(7,&Units); f.Add(8,&pWorld); f.Add(9,&bAITurn); return 0; }
	//
private:
	// TBSEvents
	void OnTurnStarted();
